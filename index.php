    ...
    <div class="row align-items-center">
      <div class="col-lg-12">
        <div class="slider_content_3 text-center">
          ...
          <h2 class="main_title">Master your <span>GS preparation</span> using <span>GS Search </span> engine</h2>
          <?php
          $sqry_topcs = "SELECT topicsm_id, topicsm_name,topicsm_img from addques_mst
            ...
            where topicsm_sts='a' and addquesm_sts = 'a' and prodmnexmsm_sts = 'a' and exam_subcategorym_sts = 'a' group by topicsm_id order by topicsm_name asc limit 12";
      ...
      <div class="row justify-content-center">
        <div class="col-lg-8">
          <div class="section_title text-center pb-20">
            ...
            <p>In the GS Search Practice Zone, you can engage in targeted practice with thousands of questions categorized
              by exams and topics.</p>
          </div>
        </div>
      </div>
      <div class="row">
