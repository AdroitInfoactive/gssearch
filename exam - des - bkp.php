...
<div class="single_courses_details  mb-60">
          ...
          <div class="courses_curriculum mt-50">
            <div class="courses_top_bar d-sm-flex justify-content-between align-items-center">
                <div class="courses_title">
                    <h4 class="courses_details_title">'Rapid Financing Instrument' and 'Rapid Credit Facility' are related to the provisions of lending by which one of the following ?
</h4>
                </div>
      ...
      <div class="custom-control custom-radio">
       ...
       <div class="custom-control custom-radio">
        ...
        <label class="custom-control-label" for="customRadioInlineD">United Nations Environment Programme Finance Initiative
</label>
      </div>
              ...
              <p><strong><span class="text-success"><i class="fa fa-check"></i> Correct</span> <span class="text-danger"><i class="fa fa-close"></i> Wrong</span></strong></p>
            </div>
...
<p>Therefore, RFI and RCF are provisions of lending by the IMF to provide emergency financial assistance to member countries.</p>
              ...
              <div class="row">    <div class="col-6">       <div class="single_form">
                                        <button class="main-btn">Prev</button>
                                    </div></div>
                                    
                        
                      <div class="col-6 text-right">  <div class="single_form">
