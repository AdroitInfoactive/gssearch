...
/**********************************************************
Programm : add_advertisement.php 
...
if (isset($_POST['btnadvdsbmt']) && (trim($_POST['btnadvdsbmt']) != "") && isset($_POST['txtname']) && (trim($_POST['txtname']) != "") && isset($_POST['txtprior']) && (trim($_POST['txtprior']) != "")) {
	...
	include_once "../database/iqry_advd_mst.php";
}
...
<script language="javascript" type="text/javascript">
	function funcChkDupName() {
		...
		if (name != "") {
			var url = "chkduplicate.php?advdname=" + name;
			...
			<form name="frmaddvehbrnd" id="frmaddvehbrnd" method="post" action="<?php $_SERVER['PHP_SELF']; ?>"
				...
				<div class="col-md-12">
					<div class="row justify-content-center align-items-center">
						...
						<p class="text-center">
							<input type="Submit" class="btn btn-primary" name="btnadvdsbmt" id="btnadvdsbmt" value="Submit">
							&nbsp;&nbsp;&nbsp;
