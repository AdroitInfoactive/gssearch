...
/*****header link********/
global $gmsg;
if (isset($_POST['btnbodsbmt']) && (trim($_POST['btnbodsbmt']) != "") && isset($_POST['txtname']) && (trim($_POST['txtname']) != "") && isset($_POST['txtprior']) && (trim($_POST['txtprior']) != "")) {
	include_once "../includes/inc_fnct_fleupld.php"; // For uploading files 
	include_once "../database/iqry_bod_mst.php";
}
...
<script language="javascript" type="text/javascript">
	function funcChkDupName() {
		var typ = document.getElementById('lstcat').value;
		var name = document.getElementById('txtname').value;
		if (name != "" && typ != "") {
			var url = "chkduplicate.php?bodname=" + name+"&bodtyp=" + typ;
...
<section class="content">
	<div class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1 class="m-0 text-dark">Add BoD</h1>
				</div><!-- /.col -->
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						<li class="breadcrumb-item"><a href="#">Home</a></li>
						<li class="breadcrumb-item active">Add BoD</li>
					</ol>
				</div><!-- /.col -->
			</div><!-- /.row -->
		</div><!-- /.container-fluid -->
					...
					<div class="row justify-content-center align-items-center">
							...
							<div class="row mb-2 mt-2">
								...
								<div class="col-sm-9">
									<div class="custom-file">
										<input name="fledbodimg" type="file" class="form-control" id="fledbodimg" maxlength="250">
									</div>
								</div>
							</div>
						</div>
						<!-- <div class="col-md-12">
							<div class="row mb-2 mt-2">
								...
								<div class="col-sm-9">
									<div class="custom-file">
										<input name="flembodimg" type="file" class="form-control" id="flembodimg" maxlength="250">
									</div>
								</div>
							</div>
						</div>
						...
						<p class="text-center">
							<input type="Submit" class="btn btn-primary" name="btnbodsbmt" id="btnbodsbmt" value="Submit">
							&nbsp;&nbsp;&nbsp;
							<input type="reset" class="btn btn-primary" name="btnbodreset" value="Clear" id="btnbodreset">
							&nbsp;&nbsp;&nbsp;
