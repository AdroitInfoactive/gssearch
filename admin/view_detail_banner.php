...
$sqrybnr_mst = "SELECT bnrm_name, bnrm_desc, bnrm_lnk, if(bnrm_sts = 'a', 'Active','Inactive') as bnrm_sts, bnrm_prty, bnrm_dimgnm, bnrm_mimgnm 
...
<section class="content">
	...
	<form name="frmedtbnrid" id="frmedtbnrid" method="post" action="<?php $_SERVER['PHP_SELF']; ?>"
		onSubmit="return performCheck('frmedtbnrid', rules, 'inline');">
				...
				<div class="row justify-content-center">
					<div class="col-md-12">
						...
						<!-- <div class="form-group row">
							...
							<div class="col-sm-8">
								<?php if ($rowsbnr_mst['bnrm_text'] == 'L')
									echo 'Left'; ?>
								<?php if ($rowsbnr_mst['bnrm_text'] == 'R')
									echo 'Right'; ?>
								<?php if ($rowsbnr_mst['bnrm_text'] == 'C')
									echo 'Center'; ?>
						...
						<div class="form-group row">
							...
							<div class="col-sm-8">
								<?php
								$mbnrimgnm = $rowsbnr_mst['bnrm_mimgnm'];
								$mbnrimgpath = $gbnr_fldnm . $mbnrimgnm;
								if (($mbnrimgnm != "") && file_exists($mbnrimgpath)) {
									echo "<img src='$mbnrimgpath' width='100pixel' height='100pixel'>";
								} else {
									echo "Image not available";
								}
								?>
