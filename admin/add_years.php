...
/*****header link********/
global $gmsg;
if (isset($_POST['btnyearssbmt']) && (trim($_POST['btnyearssbmt']) != "") && isset($_POST['txtname']) && (trim($_POST['txtname']) != "") && isset($_POST['txtprty']) && (trim($_POST['txtprty']) != "")) {
	include_once "../includes/inc_fnct_fleupld.php";
	include_once "../database/iqry_years_mst.php";
}
...
<script language="javascript" type="text/javascript">
	var rules = new Array();
	rules[0] = 'txtname:Name|required|Enter Year';
			...
			<form name="frmaddprodmn_cat" id="frmaddprodmn_cat" method="post" action="<?php $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data" onSubmit="return performCheck('frmaddprodmn_cat', rules, 'inline');">
				<div class="col-md-12">
					<div class="row justify-content-center align-items-center">
						...
						<p class="text-center">
							<input type="Submit" class="btn btn-primary" name="btnyearssbmt" id="btnyearssbmt" value="Submit">
							&nbsp;&nbsp;&nbsp;
