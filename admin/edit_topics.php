...
Modified By : 
Modified On : btnetopicssbmtedtpdctid
Purpose : 
Company : Adroit
************************************************************/
...
isset($_POST['txtprty']) && (trim($_POST['txtprty']) != ""))
{
	...
	include_once "../database/uqry_topics_mst.php";
}
...
<script language="javascript" type="text/javascript">
	function funcChkDupName()
	{
		...
		if((name != "") && (id != ""))
		{
			var url = "chkduplicate.php?topicsname="+name+"&prodmncatid="+id;
...
<section class="content">
	<div class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1 class="m-0 text-dark">Edit Main Topic <Link:mf></Link:mf></h1>
				</div><!-- /.col -->
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						<li class="breadcrumb-item"><a href="#">Home</a></li>
						<li class="breadcrumb-item active">Edit Main Topic</li>
					</ol>
				</div><!-- /.col -->
			</div><!-- /.row -->
		</div><!-- /.container-fluid -->
	</div>
	<form name="frmedttopics" id="frmedttopics" method="post" action="<?php $_SERVER['PHP_SELF'];?>" enctype="multipart/form-data" onSubmit="return performCheck('frmedttopics', rules, 'inline');">
		...
		<div class="card">
			<div class="card-body">
				<div class="row justify-content-center">
					...
					<p class="text-center">
						<input type="Submit" class="btn btn-primary btn-cst" name="btnetopicssbmt" id="btnetopicssbmt" value="Submit">
						&nbsp;&nbsp;&nbsp;
