...
Modified By : 
Modified On : btneyearssbmtedtpdctid
Purpose : 
Company : Adroit
************************************************************/
...
isset($_POST['txtprty']) && (trim($_POST['txtprty']) != ""))
{
	...
	include_once "../database/uqry_years_mst.php";
}
...
<script language="javascript" type="text/javascript">
	function funcChkDupName()
	{
		...
		if((name != "") && (id != ""))
		{
			var url = "chkduplicate.php?yearsname="+name+"&prodmncatid="+id;
...
<section class="content">
	...
	<form name="frmedtyears" id="frmedtyears" method="post" action="<?php $_SERVER['PHP_SELF'];?>" enctype="multipart/form-data" onSubmit="return performCheck('frmedtyears', rules, 'inline');">
...
<!-- 					
					...
					<p class="text-center">
						<input type="Submit" class="btn btn-primary btn-cst" name="btneyearssbmt" id="btneyearssbmt" value="Submit">
						&nbsp;&nbsp;&nbsp;
