...
// $rowsprodmncat_mst = mysqli_fetch_assoc($srsprodmncat_mst);
  ...
  $sqryprodcat_mst="SELECT 
		...
		if($cntrecprodcat_mst  > 0){
			...
			// $db_cattyp		 = $rowsprodcat_mst['prodmnexmsm_typ'];
			// $db_dsplytyp     = $rowsprodcat_mst['prodmnexmsm_dsplytyp'];
...
<script language="javascript">
	...
	{
		document.frmedtprodmnexms.action="<?php echo $rd_edtpgnm;?>?vw=<?php echo $id;?>&pg=<?php echo $pg;?>&countstart=<?php echo $countstart.$loc;?>";
		document.frmedtprodmnexms.submit();
	}
</script>
<?php 
...
<section class="content">
	<div class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1 class="m-0 text-dark">View Exam Category</h1>
				</div><!-- /.col -->
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						<li class="breadcrumb-item"><a href="#">Home</a></li>
						<li class="breadcrumb-item active">View Exam Category</li>
					</ol>
				</div><!-- /.col -->
			</div><!-- /.row -->
		</div><!-- /.container-fluid -->
	</div>
	<form name="frmedtprodmnexms" id="frmedtprodmnexms" method="post" action="<?php $_SERVER['PHP_SELF'];?>" onSubmit="return performCheck('frmedtprodmnexms', rules, 'inline');">
			...
			<div class="card-body">
				<div class="row justify-content-center">
					<div class="col-md-12">
						...
						<p class="text-center">
							<input type="Submit" class="btn btn-primary btn-cst" name="frmedtprodmnexms" id="frmedtprodmnexms" value="Edit" 
						 onclick="update1()">
						 &nbsp;&nbsp;&nbsp;
