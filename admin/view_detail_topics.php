...
$sqryprodcat_mst="SELECT 
		...
		if($cntrecprodcat_mst  > 0){
			...
			$db_catname		 = $rowsprodcat_mst['topicsm_name'];
			$db_catdesc		 = stripslashes($rowsprodcat_mst['topicsm_desc']);
			// $db_cattyp		 = $rowsprodcat_mst['topicsm_typ'];
			// $db_dsplytyp     = $rowsprodcat_mst['topicsm_dsplytyp'];
			$db_catseottl	 = $rowsprodcat_mst['topicsm_seotitle'];
			$db_catseodesc	 = $rowsprodcat_mst['topicsm_seodesc'];
			$db_catseokywrd	 = $rowsprodcat_mst['topicsm_seokywrd'];
			$db_catseohone	 = $rowsprodcat_mst['topicsm_seohone'];
			$db_catseohtwo	 = $rowsprodcat_mst['topicsm_seohtwo'];
			$db_catprty		 = $rowsprodcat_mst['topicsm_prty'];
			$db_catsts		 = $rowsprodcat_mst['topicsm_sts'];
		}
$loc= "&val=$srchval";
if($chk !='')
{
...
<script language="javascript">
	...
	{
		document.frmedttopics.action="<?php echo $rd_edtpgnm;?>?vw=<?php echo $id;?>&pg=<?php echo $pg;?>&countstart=<?php echo $countstart.$loc;?>";
		document.frmedttopics.submit();
	}
</script>
<?php 
...
<section class="content">
	<div class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1 class="m-0 text-dark">View Main Topics</h1>
				</div><!-- /.col -->
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						<li class="breadcrumb-item"><a href="#">Home</a></li>
						<li class="breadcrumb-item active">View Main Topics</li>
					</ol>
				</div><!-- /.col -->
			</div><!-- /.row -->
		</div><!-- /.container-fluid -->
	</div>
	<form name="frmedttopics" id="frmedttopics" method="post" action="<?php $_SERVER['PHP_SELF'];?>" onSubmit="return performCheck('frmedttopics', rules, 'inline');">
			...
			<div class="card-body">
				<div class="row justify-content-center">
					<div class="col-md-12">
						...
						<p class="text-center">
							<input type="Submit" class="btn btn-primary btn-cst" name="frmedttopics" id="frmedttopics" value="Edit" 
						 onclick="update1()">
						 &nbsp;&nbsp;&nbsp;
