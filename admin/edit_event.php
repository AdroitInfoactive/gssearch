                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-md-12">
                        <div class="row mb-2 mt-2">
                            ...
                            <div class="col-sm-9">
                            <input name="txtlnk" type="text" class="form-control"  id="txtlnk" size="45" maxlength="240" value="<?php echo $rowsevnt_mst['evntm_lnk'];?>">
...
<div class="col-md-12">
                    ...
                    <div class="col-md-12">
                        <div class="row mb-2 mt-2">
                            ...
                            <div class="col-sm-9">
                            <input name="txtvenue" type="text"class="form-control"  value="<?php echo 
														$rowsevnt_mst['evntm_venue'];?>" id="txtvenue">
...
<div class="table-responsive">
										...
										<table width="100%" border="0" cellspacing="3" cellpadding="3">
                                            ...
                                            <td width='5%'><?php echo  $nfiles;?></td>
												...
												<td width="15%"  align="center">
													<input type="text" name="txtphtname<?php echo $nfiles?>" id="txtphtname<?php echo $nfiles?>" placeholder="Name" class="form-control" size="15" value='<?php echo  $db_evntimgnm?>'><br>
													<span id="errorsDiv_txtphtname" style="color:#FF0000"></span>
												</td>
												<td width="30%"  align="center" >
													
                                                    <input type="file" name="flesmlimg<?php echo $nfiles?>"class="form-control" id="flesmlimg<?php echo $nfiles?>" ><br/>
								</td>
								...
								<?php						   
								  ...
								  ?>
												...
												<input type="text" name="txtphtprior<?php echo $nfiles?>" id="txtphtprior<?php echo $nfiles?>" class="form-control" value="<?php echo $db_evntimgprty;?>" size="4" maxlength="3">                     
												<br>
