...
if(isset($_POST['hdnchksts']) && (trim($_POST['hdnchksts'])!="") || isset($_POST['hdnallval']) && (trim($_POST['hdnallval'])!=""))
{
	...
	$updtsts = funcUpdtAllRecSts('std_testmnl_mst','std_testmnlm_id',$id,'std_testmnlm_sts',$chkallval);
	if($updtsts == 'y')
	{
...
if(($_POST['hdnchkval']!="") && isset($_REQUEST['hdnchkval']))
{
	...
	for($i=0;$i<$count;$i++)
	{
		$sqryprodimgd_dtl = "SELECT std_testmnlm_img,std_testmnlm_id from std_testmnl_mst where std_testmnlm_id=$del[$i]";
		...
		{
			$smlimg[$i] = glb_func_chkvl($srowprodimgd_dtl['std_testmnlm_img']);
			$smlimgpth[$i] = $a_cat_std_testmnlfldnm.$smlimg[$i];
			...
			$msmlimg[$i] = glb_func_chkvl($srowprodimgd_dtl['std_testmnlm_img']);
			$msmlimgpth[$i] = $a_cat_std_testmnlfldnm . $msmlimg[$i];
...
<script language="javascript">
	...
	function srch()
	{
		...
		var txtname = document.frmnews.txtname.value;
		if(txtname !='')
		{
			if(urlval == "")
			{
	...
	<section class="content">
		<div class="content-header">
			<div class="container-fluid">
				<div class="row mb-2">
					<div class="col-sm-6">
						<h1 class="m-0 text-dark">View All Student Testimonial</h1>
					</div><!-- /.col -->
					<div class="col-sm-6">
						<ol class="breadcrumb float-sm-right">
							<li class="breadcrumb-item"><a href="#">Home</a></li>
							<li class="breadcrumb-item active">View All Student Testimonial</li>
						</ol>
					</div><!-- /.col -->
				</div><!-- /.row -->
			</div><!-- /.container-fluid -->
                    ...
                    $cnt += 1;
                      ...
                      <td align="center">
                        <a href="<?php echo $rd_edtpgnm; ?>?edit=<?php echo $db_nwid; ?>&pg=<?php echo $pgnum; ?>&countstart=<?php echo $cntstart . $loc; ?>" class="orongelinks">Edit</a>
											...
											<td align="center">
												<input type="checkbox" name="chksts" id="chksts" value="<?php echo $db_nwid;?>" <?php if($db_std_testmnlts =='a') { echo "checked";}?> onClick="addchkval(<?php echo $db_nwid;?>,'hdnchksts','frmnews','chksts');">
											</td>
											<td align="center">
