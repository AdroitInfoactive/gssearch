...
/*****header link********/
global $gmsg;
if (isset($_POST['btngrad_typsbmt']) && (trim($_POST['btngrad_typsbmt']) != "") && isset($_POST['txtname']) && (trim($_POST['txtname']) != "") && isset($_POST['txtprior']) && (trim($_POST['txtprior']) != "")) {
	include_once "../includes/inc_fnct_fleupld.php"; // For uploading files 
	include_once "../database/iqry_grad_typ_mst.php";
}
...
<script language="javascript" type="text/javascript">
	function funcChkDupName() {
		...
		if (name != "") {
			var url = "chkduplicate.php?grad_typname=" + name;
...
<section class="content">
	<div class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1 class="m-0 text-dark">Add Graduation Type</h1>
				</div><!-- /.col -->
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						<li class="breadcrumb-item"><a href="#">Home</a></li>
						<li class="breadcrumb-item active">Add Graduation Type</li>
					</ol>
				</div><!-- /.col -->
			</div><!-- /.row -->
		</div><!-- /.container-fluid -->
					...
					<div class="row justify-content-center align-items-center">
							...
							<div class="row mb-2 mt-2">
								...
								<div class="col-sm-9">
									<div class="custom-file">
										<input name="fledgrad_typimg" type="file" class="form-control" id="fledgrad_typimg" maxlength="250">
									</div>
								</div>
							</div>
						</div> -->
						<!-- <div class="col-md-12">
							<div class="row mb-2 mt-2">
								...
								<div class="col-sm-9">
									<div class="custom-file">
										<input name="flemgrad_typimg" type="file" class="form-control" id="flemgrad_typimg" maxlength="250">
									</div>
								</div>
							</div>
						</div>
						...
						<p class="text-center">
							<input type="Submit" class="btn btn-primary" name="btngrad_typsbmt" id="btngrad_typsbmt" value="Submit">
							&nbsp;&nbsp;&nbsp;
							<input type="reset" class="btn btn-primary" name="btngrad_typreset" value="Clear" id="btngrad_typreset">
							&nbsp;&nbsp;&nbsp;
