        ...
        <form name="frmaddprodcat" id="frmaddprodcat" method="post" action="<?php $_SERVER['PHP_SELF']; ?>"
          ...
          <div class="col-md-12">
            ...
            <div class="row justify-content-center align-items-center">
              ...
              <div class="col-md-12">
                <p align="right"><a href="sample gs search.xlsm" download="sample gs search.xlsm">Download Sample Excel
                    File</a></p>
                <div class="row mb-2 mt-2">
                  <div class="col-sm-3"> <label>1 File (Upload only xls file)*</label> </div>
                  <div class="col-sm-6"><input type="file" class="form-control" id="fleblkupld" name="fleblkupld"
                      required class="form-control">

                    <span id="errorsDiv_txtname"></span>
                  </div>
                  <div class="col-sm-3">
                    <p class="text-center"> <input type="Submit" class="btn btn-primary" name="clmsbmt" id="clmsbmt"
                        value="Submit">
                      &nbsp;&nbsp;&nbsp;
                      <input type="reset" class="btn btn-primary" name="btnprodcatreset" value="Clear"
                        id="btnprodcatreset">
                      &nbsp;&nbsp;&nbsp;
