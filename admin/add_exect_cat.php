...
/*****header link********/
global $gmsg;
if (isset($_POST['btnexect_catsbmt']) && (trim($_POST['btnexect_catsbmt']) != "") && isset($_POST['txtname']) && (trim($_POST['txtname']) != "") && isset($_POST['txtprior']) && (trim($_POST['txtprior']) != "")) {
	include_once "../includes/inc_fnct_fleupld.php"; // For uploading files 
	include_once "../database/iqry_exect_cat_mst.php";
}
...
<script language="javascript" type="text/javascript">
	function funcChkDupName() {
		...
		if (name != "") {
			var url = "chkduplicate.php?exect_catname=" + name;
...
<section class="content">
	<div class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1 class="m-0 text-dark">Add Executive Category Type</h1>
				</div><!-- /.col -->
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						<li class="breadcrumb-item"><a href="#">Home</a></li>
						<li class="breadcrumb-item active">Add Executive Category Type</li>
					</ol>
				</div><!-- /.col -->
			</div><!-- /.row -->
		</div><!-- /.container-fluid -->
					...
					<div class="row justify-content-center align-items-center">
						...
						<div class="col-md-12">
							<div class="row mb-2 mt-2">
								...
								<div class="col-sm-9">
									<input name="flecatimg" type="file" id="flecatimg" size="45" maxlength="40"  class="form-control">
									<span id="errorsDiv_flecatimg"></span>
								</div>
							</div>
						</div>
						<div class="col-md-12">
							...
							<div class="row mb-2 mt-2">
								...
								<div class="col-sm-9">
									<div class="custom-file">
										<input name="fledexect_catimg" type="file" class="form-control" id="fledexect_catimg" maxlength="250">
									</div>
								</div>
							</div>
						</div> -->
						<!-- <div class="col-md-12">
							<div class="row mb-2 mt-2">
								...
								<div class="col-sm-9">
									<div class="custom-file">
										<input name="flemexect_catimg" type="file" class="form-control" id="flemexect_catimg" maxlength="250">
									</div>
								</div>
							</div>
						</div>
						...
						<p class="text-center">
							<input type="Submit" class="btn btn-primary" name="btnexect_catsbmt" id="btnexect_catsbmt" value="Submit">
							&nbsp;&nbsp;&nbsp;
							<input type="reset" class="btn btn-primary" name="btnexect_catreset" value="Clear" id="btnexect_catreset">
							&nbsp;&nbsp;&nbsp;
