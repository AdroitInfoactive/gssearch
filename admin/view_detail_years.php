...
$sqryprodcat_mst="SELECT 
			yearsm_name,yearsm_desc,yearsm_seotitle,yearsm_seodesc,
			yearsm_seohone,yearsm_seohtwo,yearsm_seokywrd,yearsm_prty, 
			if(yearsm_sts = 'a', 'Active','Inactive') as yearsm_sts
		from 
			years_mst
						  where 
							yearsm_id=$id";
		...
		if($cntrecprodcat_mst  > 0){
			...
			$db_catname		 = $rowsprodcat_mst['yearsm_name'];
			$db_catdesc		 = stripslashes($rowsprodcat_mst['yearsm_desc']);
			// $db_cattyp		 = $rowsprodcat_mst['yearsm_typ'];
			// $db_dsplytyp     = $rowsprodcat_mst['yearsm_dsplytyp'];
			$db_catseottl	 = $rowsprodcat_mst['yearsm_seotitle'];
			$db_catseodesc	 = $rowsprodcat_mst['yearsm_seodesc'];
			$db_catseokywrd	 = $rowsprodcat_mst['yearsm_seokywrd'];
			$db_catseohone	 = $rowsprodcat_mst['yearsm_seohone'];
			$db_catseohtwo	 = $rowsprodcat_mst['yearsm_seohtwo'];
			$db_catprty		 = $rowsprodcat_mst['yearsm_prty'];
			$db_catsts		 = $rowsprodcat_mst['yearsm_sts'];
		}
$loc= "&val=$srchval";
if($chk !='')
{
...
<script language="javascript">
	...
	{
		document.frmedtyears.action="<?php echo $rd_edtpgnm;?>?vw=<?php echo $id;?>&pg=<?php echo $pg;?>&countstart=<?php echo $countstart.$loc;?>";
		document.frmedtyears.submit();
	}
</script>
<?php 
...
<section class="content">
	<div class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1 class="m-0 text-dark">View Main Exams</h1>
				</div><!-- /.col -->
				<div class="col-sm-6">
	...
	<form name="frmedtyears" id="frmedtyears" method="post" action="<?php $_SERVER['PHP_SELF'];?>" onSubmit="return performCheck('frmedtyears', rules, 'inline');">
					...
					<div class="col-md-12">
						...
						<!-- <div class="form-group row">
							...
							<div class="col-sm-8">
								...
								$imgnm   = $rowsprodcat_mst['yearsm_bnrimg'];
						...
						<p class="text-center">
							<input type="Submit" class="btn btn-primary btn-cst" name="frmedtyears" id="frmedtyears" value="Edit" 
						 onclick="update1()">
						 &nbsp;&nbsp;&nbsp;
