...
/***************************************************************
Programm : view_detail_advertisement.php	
Purpose : For Viewing advertisement Details
Created By : Bharath
...
$sqryadvd_mst = "SELECT advdm_name, advdm_desc, advdm_lnk, if(advdm_sts = 'a', 'Active','Inactive') as advdm_sts, advdm_prty, advdm_dimgnm
	from advd_mst where advdm_id = $id";
...
<script language="javascript">
	...
	{
		document.frmedtadvdid.action = "<?php echo $rd_edtpgnm; ?>?vw=<?php echo $id; ?>&pg=<?php echo $pg; ?>&countstart=<?php echo $countstart . $loc; ?>";
		document.frmedtadvdid.submit();
	}
</script>
...
<section class="content">
	...
	<form name="frmedtadvdid" id="frmedtadvdid" method="post" action="<?php $_SERVER['PHP_SELF']; ?>"
		onSubmit="return performCheck('frmedtadvdid', rules, 'inline');">
				...
				<div class="row justify-content-center">
					<div class="col-md-12">
						...
						<div class="form-group row">
							...
							<div class="col-sm-8">
								...
								if (($advdimgnm != "") && file_exists($advdimgpath)) {
									echo "<img src='$advdimgpath' width='100pixel' height='100pixel'>";
								} else {
						...
						<div class="form-group row">
							...
							<div class="col-sm-8">
								<?php echo $rowsadvd_mst['advdm_prty']; ?>
							</div>
						</div>
						<div class="form-group row">
							<label for="txtname" class="col-sm-2 col-md-2 col-form-label">Status</label>
							<div class="col-sm-8">
								<?php echo $rowsadvd_mst['advdm_sts']; ?>
							</div>
						</div>
						<p class="text-center">
							<input type="Submit" class="btn btn-primary btn-cst" name="frmedtadvdid" id="frmedtadvdid" value="Edit"
								onclick="update1();">
							&nbsp;&nbsp;&nbsp;
