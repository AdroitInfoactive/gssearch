...
if (($_POST['hidchkval'] != "") && isset($_REQUEST['hidchkval'])) {
  ...
  $imgpth = array();
  for ($i = 0; $i < $count; $i++) {
    $sqryevnt_mst = "SELECT evntm_fle from evnt_mst where evntm_id=$del[$i]";
    $srsevnt_mst = mysqli_query($conn, $sqryevnt_mst);
    $srowevnt_mst = mysqli_fetch_assoc($srsevnt_mst);
     $img[$i] = glb_func_chkvl($srowevnt_mst['evntm_fle']);
    $imgpth[$i] = $gevnt_fldnm . $img[$i];
  }
  ...
  if ($delsts == 'y') {
    ...
    $sqry_imgnm = "SELECT evntimgd_img from evntimg_dtl where evntimgd_evntm_id=$did";
    $srsevnt_img = mysqli_query($conn, $sqry_imgnm);
    while($srowevnt_img = mysqli_fetch_assoc($srsevnt_img)){
      $img = glb_func_chkvl($srowevnt_img['evntimgd_img']);
      $img_pth = $imgevnt_fldnm.$img;
      if ($img != "" && file_exists($img_pth)){
        unlink($img_pth);
      }
    }

    $delsts1 = funcDelAllRec($conn, 'evntimg_dtl', 'evntimgd_evntm_id', $did);
...
$sqrynews_mst1 = "SELECT evntm_id,evntm_name,evntm_fle,evntm_sts,evntm_typ, evntm_prty,date_format(evntm_strtdt,'%d-%m-%Y') as evntm_strtdt,evntm_city from evnt_mst where evntm_id!=''"; 
  ...
  <section class="content">
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">View All Events / News</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
              ...
              <div class="col-sm-3">
                <div class="form-group">
                  <!-- <div class="col-8">
                    <div class="row">
                      <div class="col-10"> -->
                        <input type="text" name="txtsrchval" placeholder="Search by name" id="txtsrchval" class="form-control"
                ...
                <div class="col-sm-3">
                  <div class="form-group">
                    <?php
                    $sqryprodcat_mst = "SELECT  evntm_id,evntm_name,evntm_fle,evntm_sts,evntm_typ, evntm_prty,date_format(evntm_strtdt,'%d-%m-%Y') as evntm_strtdt,evntm_city from evnt_mst where evntm_id!=''"; 
                  ...
                  <td width="7%" align="right" valign="bottom">
                    <div align="right">
                      ...
                      <input name="btnsts" id="btnsts" type="button" class="btn btn-xs btn-primary" value="Status"
                        onClick="updatests('hidchksts','frmevnt','chksts')">
                    </div>
                  </td>
                  <td width="7%" align="right" valign="bottom">
                    <div align="right">
                      <input name="btndel" id="btndel" type="button" class="btn btn-xs btn-primary" value="Delete"
                        onClick="deleteall('hidchkval','frmevnt','chkdlt');">
                    </div>
                  </td>
                </tr>
                <tr>
                  ...
                  <td width="7%" class="td_bg" align="center"><strong>
                      <input type="checkbox" name="Check_ctr" id="Check_ctr" value="yes"
                        onClick="Check(document.frmevnt.chksts,'Check_ctr','hdnallval')"></strong></td>
                  <td width="7%" class="td_bg" align="center"><strong>
                      <input type="checkbox" name="Check_dctr" id="Check_dctr" value="yes"
                        onClick="Check(document.frmevnt.chkdlt,'Check_dctr')"></strong></td>
                </tr>
                <?php
                $cnt = $offset;
                if ($serchres > 0) {
                  while ($srowevnt_mst = mysqli_fetch_assoc($srsnews_mst)) {
                    ...
                    <tr <?php if ($cnt % 2 == 0) {
                      ...
                      <td>
                        <a href="view_event.php?edit=<?php echo $srowevnt_mst['evntm_id']; ?>&pg=<?php echo $pgnum; ?>&countstart=<?php echo $cntstart . $loc; ?>"
                          class="links">
                      ...
                      <td align="center">
                        <a href="edit_event.php?edit=<?php echo $srowevnt_mst['evntm_id']; ?>&pg=<?php echo $pgnum; ?>&countstart=<?php echo $cntstart . $loc; ?>"
                          class="contentlinks">
                          Edit
                        </a>
                        <!-- <td align="left"> -->
                  ...
                  <tr>
                    ...
                    <td width="7%" align="right" valign="bottom">
                      <div align="right">
                        ...
                        onClick="updatests('hidchksts','frmevnt','chksts')" class="btn btn-xs btn-primary">
                      </div>
                    </td>
                  <td width="7%" align="right" valign="bottom">
                    <div align="right">
                      <input name="btndel" id="btndel" type="button" value="Delete"
                        onClick="deleteall('hidchkval','frmevnt','chkdlt');" class="btn btn-xs btn-primary">
                    </div>
                  </td>
                </tr>
                <?php
