...
$sqryprodscat_mst = "SELECT abtusm_id,abtusm_name,abtusm_desc,abtusm_lnk, abtusm_prty, if(abtusm_sts = 'a', 'Active','Inactive') as abtusm_sts from abtus_mst where abtusm_id=$id";
...
<section class="content">
  ...
  <form name="frmedtbrnd" id="frmedtbrnd" method="post" action="<?php $_SERVER['PHP_SELF']; ?>"
    onSubmit="return performCheck('frmedtbrnd', rules, 'inline');">
      ...
      <div class="card-body">
        <div class="row justify-content-center">
          <div class="col-md-12">
            ...
            <p class="text-center">
              <input type="Submit" class="btn btn-primary btn-cst" name="btnedtbrnd" id="btnedtbrnd" value="Edit"
                onclick="update1();">
              &nbsp;&nbsp;&nbsp;
