...
if (($_POST['hdnchksts'] != "") && isset($_REQUEST['hdnchksts'])) {
	...
	$updtsts = funcUpdtAllRecSts($conn, 'pgcnts_dtl', 'pgcntsd_id', $id, 'pgcntsd_sts');
	if ($updtsts == 'y') {
...
<section class="content">
	...
	<div class="card">
		...
		<form method="POST" action="<?php $_SERVER['SCRIPT_FILENAME']; ?>" name="frmpgcntn" id="frmpgcntn" onSubmit="return validate()">
								...
								<div class="row">
									<div class="col-10">
										<select name="lstsrchby" id="lstsrchby" onChange="chng()" class="form-control">
											...
											<?php /*?><option value="d"<?php if(isset($_REQUEST['lstsrchby']) && trim($_REQUEST['lstsrchby'])=='d'){echo 'selected';}else if(isset($_REQUEST['optn']) && trim($_REQUEST['optn'])=='d'){echo 'selected';}?>>Department</option><?php */ ?>
					...
					<div class="col-sm-4">
						<div class="form-group">
							<div id="div1" <?php if (!isset($_REQUEST['optn']) || (trim($_REQUEST['optn']) == "nm") || (trim($_REQUEST['optn']) == "")) {
								...
								<input type="text" name="txtsrchval" value="<?php if (isset($_REQUEST['txtsrchval']) && trim($_REQUEST['txtsrchval']) != "") {
					...
					<div class="col-sm-3">
						<div class="form-group">
							<div id="div2" <?php if (isset($_REQUEST['optn']) && (trim($_REQUEST['optn']) == "d")) {
								...
								<select name="lstdept" id="lstdept" style="width:250px">
									<option value="">--Select--</option>
									<?php
									$sqrydept_mst = "select 
													  deptm_id,deptm_name
					...
					<div class="col-sm-3">
						<div class="form-group">
							<div id="div3" <?php if (isset($_REQUEST['optn']) && (trim($_REQUEST['optn']) == "catone")) {
								...
								<select name="lstcatone" id="lstcatone" style="width:250px">
									<option value="">--Select--</option>
									<?php
					...
					<div class="col-sm-3">
						<div class="form-group">
							<div id="div4" <?php if (isset($_REQUEST['optn']) && (trim($_REQUEST['optn']) == "cattwo")) {
								...
								<select name="lstcattwo" id="lstcattwo" style="width:250px">
									<option value="">--Select--</option>
									<?php
						...
						<table width="100%">
							<tr>
								...
								<td width="22%">
									...
									<a href="view_all_pagecontain.php" class="mainlinks">Refresh</a>
								</td>
							</tr>
						</table>
					</td>
			...
			<table width="100%" border="0" cellpadding="8" cellspacing="1" bgcolor="#f9f9f9">
				<tr>
				<tr>
					<td bgcolor="#FFFFFF" colspan="<?php echo $clspn_val - 2; ?>" align="center">
						<?php
						if ($msg != "") {
							echo $msg;
						}
					...
					?>
						<td width="8%" align="center" valign="bottom" bgcolor="#FFFFFF">
							<input name="btnsts" id="btnsts" type="button" value="Status" onClick="updatests('hdnchksts','frmpgcntn','chksts')">
						</td>
					<?php
					}
					...
					?>
						<td width="8%" align="center" valign="bottom" bgcolor="#FFFFFF">
							<input name="btndel" id="btndel" type="button" value="Delete" onClick="deleteall('hdnchkval','frmpgcntn','chkdlt');">
						</td>
					<?php
					}
					?>
				...
				<tr>
					<td width="4%" bgcolor="#bed8f9" class="tableheadings"><strong>Sl.No.</strong></td>
					<td width="26%" bgcolor="#bed8f9" class="tableheadings"><strong>Name</strong></td>
					<td width="13%" bgcolor="#bed8f9" class="tableheadings"><strong>Subcategory</strong></td>
					<td width="12%" bgcolor="#bed8f9" class="tableheadings"><strong>Category</strong></td>
					<?php /*?><td width="12%" bgcolor="#bed8f9" class="tableheadings"><strong>Department</strong></td><?php */ ?>
					<td width="13%" bgcolor="#bed8f9" class="tableheadings"><strong>Banner Images</strong></td>
					<td width="10%" align="left" bgcolor="#bed8f9" class="tableheadings"><strong>Type</strong></td>
					<td width="5%" bgcolor="#bed8f9" class="tableheadings" align="center"><strong>Rank</strong></td>
					<?php
					if (($rqst_stp_attn[1] == '3') || ($rqst_stp_attn[1] == '4') || $ses_admtyp == 'a') {
					?>
						<td width="5%" bgcolor="#bed8f9" class="tableheadings" align="center"><strong>Edit</strong></td>
						<td width="5%" bgcolor="#bed8f9" class="tableheadings" align="center"><strong>
					...
					?>
						<td width="5%" bgcolor="#bed8f9" class="tableheadings" align="center"><strong>
								<input type="checkbox" name="Check_dctr" id="Check_dctr" value="yes" onClick="Check(document.frmpgcntn.chkdlt,'Check_dctr')"><b></b>
							</strong>
						</td>
					<?php
					}
				...
				$srspgcnts_dtl = mysqli_query($conn, $sqrypgcnts_dtl) or die(mysqli_error());
				$cnt = $offset;
				...
				?>
						<tr <?php if ($cnt % 2 == 0) {
							...
							<?php /*?><td align="left" valign="top"><?php echo $db_pgcntdeptnm;?></td><?php */ ?>
							<td align="left" valign="top">
								<?php
				...
				?>
				<?php
				$disppg = funcDispPag('links', $loc, $sqrypgcnts_dtl1, $rowsprpg, $cntstart, $pgnum, $conn);
				if ($disppg != "") {
					$disppg = "<br><tr><td colspan='$clspn_val' align='center' bgcolor='#f1f6fd'>$disppg</td></tr>";
					echo $disppg;
				}
				?>
			</table>
			<table width="100%" border="0" cellpadding="3" cellspacing="1">
				<tr>
					<td width="85%" colspan="<?php echo $clspn_val - 2; ?>">&nbsp;</td>
					<?php
					if (($rqst_stp_attn[1] == '3') || ($rqst_stp_attn[1] == '4') || $ses_admtyp == 'a') {
					?>
						<td width="9%" align="center" valign="bottom" bgcolor="#FFFFFF">
							<input name="btnsts" id="btnsts" type="button" value="Status" onClick="updatests('hdnchksts','frmpgcntn','chksts')">
						</td>
					<?php
					}
