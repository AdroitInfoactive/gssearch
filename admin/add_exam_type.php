...
/*****header link********/
global $gmsg;
if (isset($_POST['btnaddexams']) && (trim($_POST['btnaddexams']) != "") && isset($_POST['txtname']) && (trim($_POST['txtname']) != "") && isset($_POST['txtprior']) && (trim($_POST['txtprior']) != "")) {
	include_once "../includes/inc_fnct_fleupld.php"; // For uploading files 
	include_once "../database/iqry_exam_type_mst.php";
}
			...
			<form name="frmaddvehbrnd" id="frmaddvehbrnd" method="post" action="<?php $_SERVER['PHP_SELF']; ?>"
				...
				<div class="col-md-12">
					<div class="row justify-content-center align-items-center">
						...
						<p class="text-center">
							<input type="Submit" class="btn btn-primary" name="btnaddexams" id="btnaddexams" value="Submit">
							&nbsp;&nbsp;&nbsp;
