				...
				<div class="row justify-content-center align-items-center">
					<div class="col-md-12">
						<div class="row mb-2 mt-2">
							...
							<div class="col-sm-9">
								<input name="txtname" type="text" id="txtname" size="45" maxlength="250" onBlur="funcChkDupName()" class="form-control" value="<?php echo $rowsachmnt_mst['achmntm_name']; ?>">
					...
					<div class="col-md-12">
						<div class="row mb-2 mt-2">
							...
							<div class="col-sm-9"> 
								<input type="text" name="txtlnk" id="txtlnk" size="45" maxlength="250" class="form-control" value="<?php echo $rowsachmnt_mst['achmntm_lnk']; ?>">
							</div>
						</div>
					</div>
