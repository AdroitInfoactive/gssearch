...
/*****header link********/
global $gmsg;
if (isset($_POST['btntopicssbmt']) && (trim($_POST['btntopicssbmt']) != "") && isset($_POST['txtname']) && (trim($_POST['txtname']) != "") && isset($_POST['txtprty']) && (trim($_POST['txtprty']) != "")) {
	include_once "../includes/inc_fnct_fleupld.php";
	include_once "../database/iqry_topics_mst.php";
}
...
<script language="javascript" type="text/javascript">
	var rules = new Array();
	rules[0] = 'txtname:Name|required|Enter Topic';
...
<script language="javascript" type="text/javascript">
	function funcChkDupName() {
		...
		if (name != "") {
			var url = "chkduplicate.php?topicsname=" + name;
...
<section class="content">
	<div class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1 class="m-0 text-dark">Add Topics</h1>
				</div><!-- /.col -->
				<div class="col-sm-6">
			...
			<form name="frmaddprodmn_cat" id="frmaddprodmn_cat" method="post" action="<?php $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data" onSubmit="return performCheck('frmaddprodmn_cat', rules, 'inline');">
				<div class="col-md-12">
					<div class="row justify-content-center align-items-center">
						...
						<p class="text-center">
							<input type="Submit" class="btn btn-primary" name="btntopicssbmt" id="btntopicssbmt" value="Submit">
							&nbsp;&nbsp;&nbsp;
