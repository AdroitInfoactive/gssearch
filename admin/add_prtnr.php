...
/*****header link********/
global $gmsg;
if (isset($_POST['btnprtnrsbmt']) && (trim($_POST['btnprtnrsbmt']) != "") && isset($_POST['txtname']) && (trim($_POST['txtname']) != "") && isset($_POST['txtprior']) && (trim($_POST['txtprior']) != "")) {
	include_once "../includes/inc_fnct_fleupld.php"; // For uploading files 
	include_once "../database/iqry_prtnr_mst.php";
}
...
<script language="javascript" type="text/javascript">
	function funcChkDupName() {
		...
		if (typ!= "" && name != "") {
			var url = "chkduplicate.php?prtnrname=" + name+ "&typ=" + typ;
	...
	<div class="card">
		...
		<div class="card-body p-0">
            ...
            <div class="col-md-12">
							<div class="row mb-2 mt-2">
								...
								<div class="col-sm-9">
									<select name="prtnrtyp" id="prtnrtyp" class="form-control">
										<option value="s">Strategic</option>
							...
							<div class="row mb-2 mt-2">
								...
								<div class="col-sm-9">
									<div class="custom-file">
										<input name="fleprtnrimg" type="file" class="form-control" id="fleprtnrimg" maxlength="250">
									</div>
								</div>
							</div>
						</div>
						...
						<p class="text-center">
							<input type="Submit" class="btn btn-primary" name="btnprtnrsbmt" id="btnprtnrsbmt" value="Submit">
							&nbsp;&nbsp;&nbsp;
							<input type="reset" class="btn btn-primary" name="btnprtnrreset" value="Clear" id="btnprtnrreset">
							&nbsp;&nbsp;&nbsp;
