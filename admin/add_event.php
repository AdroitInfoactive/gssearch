...
<script language="javascript" type="text/javascript">
	function funcChkDupName(){
		...
		var evntid = document.getElementById('addtype').value;
		if(name != ""&& (evntid != "")){
			var url = "chkduplicate.php?evntname="+name+"&evntid="+evntid;
					...
					<div class="col-md-12">
						...
						<div class="col-md-12">
							<div class="row mb-2 mt-2">
								...
								<div class="col-sm-9">
									<input name="txtname" type="text"  id="txtname" size="45" maxlength="250"  class="form-control" onBlur="funcChkDupName()">
