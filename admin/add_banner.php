					...
					<div class="row justify-content-center align-items-center">
							...
							<div class="row mb-2 mt-2">
								...
								<div class="col-sm-9">
									<div class="custom-file">
										<input name="fledbnrimg" type="file" class="form-control" id="fledbnrimg" maxlength="250">
									</div>
								</div>
							</div>
						</div>
						<div class="col-md-12">
							<div class="row mb-2 mt-2">
								...
								<div class="col-sm-9">
									<div class="custom-file">
										<input name="flembnrimg" type="file" class="form-control" id="flembnrimg" maxlength="250">
									</div>
								</div>
							</div>
						</div>
