	...
	<div class="wrapper">
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<div class="user-panel mt-3 pb-3 mb-3 d-flex">
				<div class="image">
					<img src="<?php echo $rtpth; ?>assets/images/logos/ihm-logo-main.png" class="elevation-2" alt="G S Search"
					...
					<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
						...
						<li class="nav-item has-treeview <?php if ($pagemncat == "Setup") {
							...
							<ul class="nav nav-treeview <?php if ($pagemncat == "Setup") {
								...
								<li class="nav-item">
									<a href="view_main_category.php" class="nav-link <?php if ($pagenm == "Exams") {
										echo "active";
									} ?>">
										<i class="far fa-dot-circle nav-icon"></i>
										<p>Exams</p>
